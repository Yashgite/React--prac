    ...
    return(
        ...
        <StepIndicator step={step}/>
            <form onSubmit={handleSubmit}>
                {step === 1 && <PersonalInfo showErrors={showErrors} err={err} setErr={setErr} formdata={formdata} setFormdata={setFormdata}/>}
                {step === 2 && <AddressInfo showErrors={showErrors} err={err} setErr={setErr} formdata={formdata} setFormdata={setFormdata}/>}
                ...
                <div>
                    ...
                    (step>1 && step<3) && <div>
                                                ...
                                                <button onClick={handleNext} type="button">Review</button>
                                          </div> 
                    }
